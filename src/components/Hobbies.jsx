...
const Hobbies = () => {
    ...
    <Menu/>
    <Body
            mainTitle='My Interest'
            upperUnderTitle='Things I enjoy on a daily basis'
            midContant=''
        />
    <div className="grid-container-hobbies fadeIn">
        <div className="v P-5 M-3"><img className='img-scale' src={Game} alt='video games'/></div>
        ...
        <div className="h P-5 M-3"><img className='img-scale' src={Paint} alt='paint'/></div>
        <div className="b-contant P-5">
        <h1 className='bold card-title'>Digital Art</h1>    
        <LightBox/></div>
        <div className="c P-5 M-3"><img className='img-scale' src={Video} alt='Video'/></div>
        <div className="c-contant P-5">
        <h1 className='bold card-title'>Video Art</h1>
        ...
        <a className='link-card' href={links[7]} target='_blank' rel="noreferrer"><h4 className='body-style card-content'>Tangens</h4></a>
        </div>
